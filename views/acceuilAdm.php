    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          <a class="sidebar-brand navbar-brand" href="acceuilAdm.php"><img src="assets/images/naturepet.jpg" alt="logo" /></a>
        </div>
        <ul class="nav">
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="afficheracctualite.php">Afficher les reclamations</a>
                </li>
        </ul>
            </div>
          </li>
