...
<li class="nav-item">
 ...
 <div class="row">
    ...
    <div class="container">
        ...
        <div class="col-md-5"><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<td>ID PromoAnimaux :<td></div>
			<div class="pt-4">
				   <div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text bg-warning"><i class="fas fa-book"></i></div>
                        </div>
                        <input type="text" name="id_promoanimaux" id="id_promoanimaux" value = "<?php echo $user['id_promoanimaux']; ?>" class="form-control" readonly> 
           ...
           <div class="pt-4">
                       ...
                       <div> <input type="date" name="dated" id="dated"   class="form-control" required>  </div>
                     </div> 
           ...
           <div class="pt-4">
                       ...
                       <div> <input type="number" name="prix_promotions" id="prix_promotions" value = "<?php echo $user['prix_promotions']; ?>" class="form-control" min="1" max="100" ><p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</p> </div>
                     </div> 
