<?PHP
	...
	$listeUsers=$utilisateurC->trierNourriture();
...
<body>
 ...
 <center>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li><a href="index1.php"><em class="fa fa-dashboard">&nbsp;</em>Ajouter Animaux</a></li>
		...
		<li class="active"><a href="affichernourriture.php"><em class="fa fa-calendar">&nbsp;</em>Afficher Nourriture</a></li>
