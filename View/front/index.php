...
<?PHP
	...
	$planteC=new NourritureC();
	$listeplante=$planteC->afficherNourriture();
...
<body>
	...
	<section>
		<div class="container">
								...
								<div id="sportswear" class="panel-collapse collapse">
									<div class="panel-body">
										...
										<li><a href="search1.php">Search</a></li>
											<li><a href="afficherAnimaux.php">Afficher Animaux</a></li>
								...
								<div id="mens" class="panel-collapse collapse">
									<div class="panel-body">
										...
										<li><a href="search2.php">Search</a></li>
											<li><a href="afficherNourriture.php">Afficher Nourriture</a></li>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
										...
										<table form="search.php" method="POST">
										<h2 class="title text-center">LISTE DES ANIMAUX</h2>
										
									
										<button type="button" class="btn btn-default get"><a href="afficherAnimaux.php">FULL DESCRIPTION</a></button>
										<?PHP
				foreach($listeUsers as $user){
			?>                
			
			<tr>
											<td><img src="images/<?= $user['image'] ?>" width = "300" height = "150"></td>
			...
			<center><table>
				<h2 class="title text-center">LISTE DES NOURRITURE</h2>
					<button type="button" class="btn btn-default get"><a href="afficherNourriture.php">DESCRIPTION</a></button>
			<?PHP
				foreach($listeplante as $user){
			?>
			
			<tr><td><img src="images/<?= $user['image'] ?>" width = "150" height = "150"></td>
			<td><?PHP echo $user['nom']; ?></td></tr>
