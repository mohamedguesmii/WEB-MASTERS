...
<link rel="stylesheet" href="style.css">
	...
	<option value="oiseau">Oiseau</option>
				...
				<tr>
					...
					<td>
					<button><a href="afficheranimaux.php">Afficher Animaux</a></button>
					</td>
                </tr>
            </table>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="modifieranimaux.php"><em class="fa fa-dashboard">&nbsp;</em>Modifier Animaux</a></li>
