...
include "../config.php"; 
  ...
  $UtilisateurC=new UtilisateurC();
   ...
   $listeReclamation=$ReclamationC->trieReclamation2();
?>
...
<li class="nav-item">
  ...
  <br>
    ...
    <a href="triREc.php" class="btn btn-lg btn-outline">
                    <i class="fas fa-arrow-alt-circle-up"></i></i> Tri Croissant Selon Date
                </a>
