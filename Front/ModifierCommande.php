...
if (
    ...
    && isset($_POST['DemAnnulation'])
        ...
        if(
            ...
            $C1 = new Commandes($_POST['client'],$_POST['paiment'],0,"prod");
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="AjouterCommande.php">Checkout</a></li> 
										<li><a href="AjouterCommande.php" class="active">Cart</a></li> 
			...
			<div class="shopper-info">
				<p>Modifier Commande</p>
							<form action="" method="POST">
                                ...
                                <input type="text" name="client" id="client" placeholder="Nom Client"required>
