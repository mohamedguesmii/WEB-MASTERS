			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
                        ...
                        <textarea name="message" rows="5" placeholder="vous êtes invité(e) par $name à participer à un évènement veuillez consulter notre site web" readonly></textarea>
				...
				<div class="contenir">
					<button class="btn btn1">Inviter Participant via Email</button>
